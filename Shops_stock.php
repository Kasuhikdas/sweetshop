  ...
  while($row = $result->fetch_assoc()) {
     ...
     ?>
		...
		<table border="1">
			...
			<tr><td><label id="errormsg"><?php echo $err?></label></td><td><button>Order</button></td></tr>
		</table>
    </form>
</div>
<div class="content2">
<p>Sales Figure</p>
	<table border="1">
		<tr><td width="99">Sweet Name</td><td width="92">Quantity</td><td width="63">Price</td><td width="66">Date</td></tr>
    <?php
        $servername = "localhost";
        $username = "root";
        $password = "";
